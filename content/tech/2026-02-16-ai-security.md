...
The open-source, cloud-native project Kagenti follows a similar pattern, separating an orchestrator from individual agents. It uses SPIFFE to assign identities to agent workloads and OAuth Token Exchange to narrow access tokens for inter-agent communicatio [source](https://github.com/kagenti/kagenti/blob/main/docs/components.md#identity--auth-bridge)
